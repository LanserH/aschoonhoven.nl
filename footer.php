...
<div class="aboveFooter1">
    <div class="classRow2">
      <div class="column3">
        ...
        <ul>
          <li>
            <a href="/actueel">
              <span class="inlineSpanIcon">&#62;</span> 
              Actueel
            </a>
          </li>
          <li>
            <a href="/#overOnsHomepage">
              <span class="inlineSpanIcon">&#62;</span> 
              Over ons</a>
          </li>
          <li>
            <a href="/#contactHomepage">
              <span class="inlineSpanIcon">&#62;</span> 
              Contact
            </a>
          </li>
    ...
    <svg class="svgSource" width="0" height="0" aria-hidden="true">
    <!-- de id was van oorspronkelijk svg(met dubbele -)twitter. Wegens duplicate ID is het gewijzigd naar het onderstaande -->
      <symbol id="svgTwitter" viewbox="0 -7 15 30">
      ...
      <symbol id="svgThatsapp" viewBox="0 0 800 800">
      ...
      <symbol id="svgGoogle" viewbox="-13 -13 72 72">
    ...
    c9.24,0,15.36-6.5,15.36-15.64c0-1.17-0.11-2.29-0.31-3.36C31.05,21,16,21,16,21z" />
      ...
      <symbol id="svgFacebook" viewbox="0 -7 16 30">
      ...
      <symbol id="svgGithub" viewbox="-30 -30 150 150">
      ...
      <symbol id="svgLinkedIn" viewBox="0 0 512 512">
        <path d="M186.4 142.4c0 19-15.3 34.5-34.2 34.5 -18.9 0-34.2-15.4-34.2-34.5 0-19 15.3-34.5 34.2-34.5C171.1 107.9 186.4 123.4 186.4 142.4zM181.4 201.3h-57.8V388.1h57.8V201.3zM273.8 201.3h-55.4V388.1h55.4c0 0 0-69.3 0-98 0-26.3 12.1-41.9 35.2-41.9 21.3 0 31.5 15 31.5 41.9 0 26.9 0 98 0 98h57.5c0 0 0-68.2 0-118.3 0-50-28.3-74.2-68-74.2 -39.6 0-56.3 30.9-56.3 30.9v-25.2H273.8z"/>
      </symbol>
      <symbol id="svgYoutube" viewbox="-150 -150 800 800">
    ...
    <div class="wrapper">
      ...
      <a href="" class="share twitter">
        <svg class="svgIcon">
          <use xlink:href="#svg(met dubbele -)twitter" />
        </svg>
        <span class="clip">TWITTER</span>
      </a>
      -->
      <a href="tel:+31630209619" class="share phone">
        <svg class="svgIcon" id="svg--phone" viewBox="0 0 20 20">
          <path fill="#FFFFFF" d="M13.372,1.781H6.628c-0.696,0-1.265,0.569-1.265,1.265v13.91c0,0.695,0.569,1.265,1.265,1.265h6.744c0.695,0,1.265-0.569,1.265-1.265V3.045C14.637,2.35,14.067,1.781,13.372,1.781 M13.794,16.955c0,0.228-0.194,0.421-0.422,0.421H6.628c-0.228,0-0.421-0.193-0.421-0.421v-0.843h7.587V16.955z M13.794,15.269H6.207V4.731h7.587V15.269z M13.794,3.888H6.207V3.045c0-0.228,0.194-0.421,0.421-0.421h6.744c0.228,0,0.422,0.194,0.422,0.421V3.888z"></path>
        </svg>
        <span class="clip">Bel met A Schoonhoven dienstverlening</span>
      </a>
      <a href="mailto:&#x6d;&#x61;&#000105;&#x6c;&#000116;&#111;&#x3a;&#x61;&#x72;&#106;&#x65;&#x6e;&#x40;&#97;&#x73;&#x63;&#x68;&#x6f;&#x6f;&#x6e;&#x68;&#111;&#x76;&#000101;&#110;&#x2e;&#110;&#x6c;" class="share mail">
        <svg class="svgIcon" id="svg--mail" viewBox="0 0 20 20">
          <path fill="#FFFFFF" d="M17.388,4.751H2.613c-0.213,0-0.389,0.175-0.389,0.389v9.72c0,0.216,0.175,0.389,0.389,0.389h14.775c0.214,0,0.389-0.173,0.389-0.389v-9.72C17.776,4.926,17.602,4.751,17.388,4.751 M16.448,5.53L10,11.984L3.552,5.53H16.448zM3.002,6.081l3.921,3.925l-3.921,3.925V6.081z M3.56,14.471l3.914-3.916l2.253,2.253c0.153,0.153,0.395,0.153,0.548,0l2.253-2.253l3.913,3.916H3.56z M16.999,13.931l-3.921-3.925l3.921-3.925V13.931z">
          </path>
        </svg>
        <span class="clip">Email naar A Aschoonhoven Dienstverlening</span>
        
      </a>
      <a href="https://api.whatsapp.com/send?phone=31630209619" class="share whatsapp">
        <svg class="svgIcon" id="svg--whatsapp" viewBox="0 0 800 800">
          <path fill="#FFFFFF" d="M519 454c4 2 7 10-1 31-6 16-33 29-49 29-96 0-189-113-189-167 0-26 9-39 18-48 8-9 14-10 18-10h12c4 0 9 0 13 10l19 44c5 11-9 25-15 31-3 3-6 7-2 13 25 39 41 51 81 71 6 3 10 1 13-2l19-24c5-6 9-4 13-2zM401 200c-110 0-199 90-199 199 0 68 35 113 35 113l-20 74 76-20s42 32 108 32c110 0 199-89 199-199 0-111-89-199-199-199zm0-40c133 0 239 108 239 239 0 132-108 239-239 239-67 0-114-29-114-29l-127 33 34-124s-32-49-32-119c0-131 108-239 239-239z"/>
        </svg>
        <span class="clip">Whatsapp met A Schoonhoven Dienstverlening</span>
        
      </a>
      <!--
      <a href="" rel="author" class="share google">
        <svg class="svgIcon">
          <use xlink:href="#svg(met dubbele -)google" />
          <span class="clip">GOOGLE +</span>
        </svg>
      </a>
      -->
      <!--
      <a href="https://nl-nl.facebook.com/graffus.sity" rel="author" class="share facebook">
        <svg class="svgIcon" id="svg--facebook" viewbox="0 -1 18 18">
        <path fill="#FFFFFF" d="M12 3.303h-2.285c-0.27 0-0.572 0.355-0.572 0.831v1.65h2.857v2.352h-2.857v7.064h-2.698v-7.063h-2.446v-2.353h2.446v-1.384c0-1.985 1.378-3.6 3.269-3.6h2.286v2.503z" />
        </svg>
        <span class="clip">Bezoek de Facebook pagina van A Schoonhoven</span>
      </a>
      -->
      <!--
      <a href="" class="share github">
        <svg class="svgIcon">
          <use xlink:href="#svg(met dubbele -)" />
      ...
      <a href="" class="share  pinterest">
        <svg class="svgIcon">
          <use xlink:href="#svg(met dubbele -)pinterest" />
      ...
      <a href="" class="share  youtube">
        <svg class="svgIcon">
          <use xlink:href="#svg(met dubbele -)youtube" />
          <span class="clip">YOU-TUBE</span>
        </svg>
      </a>
      -->
      <a href="https://nl.linkedin.com/in/arjen-schoonhoven-3b7014a3" class="share  linkedIn">
        <svg class="svgIcon" id="svg--linkedIn" viewBox="0 0 512 512">
        ...
        <span class="clip">Bezoek de LinkedIn pagina van A Schoonhoven</span>
      </a>
      </div>
    </div>
  </div>
  <div class="divFooter">
    <ul class="menuFooter">
      <li class="menuItemFooter"><a href="/sitemap" target="_self" class="menuLinkFooter">Sitemap</a></li>
      <li class="menuItemFooter"><a href="/disclaimer" target="_self" class="menuLinkFooter">Disclaimer</a></li>
    </ul>
</div>
</footer>
<script>
  ...
  <script src="/js/accessibleMenu2.js"></script>
  <script src="/js/dm.dist.js"></script>
  <script src="/js/cardScript.js"></script>
  <script src="/js/showPassword.js"></script>
  <script src="/js/galerij.js"></script>
