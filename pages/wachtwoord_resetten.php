    ...
    <main id="main">
        ...
        <div class="styleFormDiv">
            <div class="formCss">
                ...
                <form name="wachtwoordresetten" method="POST" enctype="multipart/form-data" action="/wachtwoordresetten&token=<?php echo $_GET["token"]?>&timestamp=<?php echo $_GET["timestamp"]?>" novalidate>
